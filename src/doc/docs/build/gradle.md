...
??? question "How to get dependencies from private GitHub repositories within a GitHub action?"
    ...
    - Make sure that this secret is not in an environment but is generally available.
...
| project properties | <ul><li>can be defined as *ext.myPropName*</li><li>passed through: -<b>P</b>myPop_name from CL</li><li> can be access like variables in the build project</li><li>can be checked if they are set or not </li></ul>                                                                         |
...
- For example: Gson is used inside a Gradle project and needs to be on the classpath of the project to be able to compile the project.
