...
Implement [ITreeViewRoot](http://127.0.0.1:63320/node?ref=r%3Af7764ca4-8c75-4049-922b-08516400a727%28com.mbeddr.core.base.structure%29%2F176285146686936640) to use the Tree tool. It is a tool that can show a tree structure when this interface is implemented.
...
[IDetectCycle](http://127.0.0.1:63320/node?ref=r%3Af7764ca4-8c75-4049-922b-08516400a727%28com.mbeddr.core.base.structure%29%2F5939454523704167063) can be implemented to detect cyclic dependencies. This feature is used, for example, with chunks that import other chunks.
...
[IEmptyLiteral](http://127.0.0.1:63320/node?ref=r%3A66e07cb4-a4b0-4bf3-a36d-5e9ed1ff1bd3%28org.iets3.core.expr.base.structure%29%2F915344943735946072) is a marker interface used to mark literals that at runtime evaluate to an empty value.
